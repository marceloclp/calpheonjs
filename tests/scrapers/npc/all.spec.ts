...
describe('NPCs', () => {
    ...
    describe('21304', () => {
        ...
        before(async () => {
            result = await ScrapeMock('21304', Scrapers.EntityTypes.NPC);
        });
    ...
    describe('23720', () => {
        ...
        before(async () => {
            result = await ScrapeMock('23720', Scrapers.EntityTypes.NPC);
        });
    ...
    describe('23746', () => {
        ...
        before(async () => {
            result = await ScrapeMock('23746', Scrapers.EntityTypes.NPC);
        });
